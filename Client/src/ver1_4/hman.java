...
public class hman extends Applet implements ActionListener {
	...
	public void init() {
		...
		//guessme = "Mohamed".toUpperCase();
		
		try {
			Socket connection = new Socket("localhost", 9999);
			BufferedWriter outputToServer = new BufferedWriter(new OutputStreamWriter(
...
//			while ((responseFromServer = outputFromServer.readLine()) != null) {
				guessme = outputFromServer.readLine();
